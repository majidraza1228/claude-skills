<!-- Apply when: Use this skill when the user has a bug, error, or unexpected behavior and needs help diagnosing it. Triggers on 'debug this', 'why is this failing', 'error I can't figure out', 'this isn't working', 'help me fix this bug', stack traces, exception messages, or 'it works locally but not in production'. Also triggers on 'reproduce this bug', 'find the root cause', or 'why does this return the wrong value'. Do NOT use for general code review — use /skills/code-review instead. -->
