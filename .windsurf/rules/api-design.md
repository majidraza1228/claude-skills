<!-- Apply when: Use this skill when the user is designing, reviewing, or changing an API, module interface, function signature, or public contract. Triggers on 'design an API', 'review this API', 'what should this endpoint return', 'API contract', 'REST endpoint design', 'function interface', 'schema design', or 'breaking change'. Also triggers on 'should I add a parameter', 'versioning strategy', or 'backwards compatibility'. Do NOT use for implementing internal logic behind an API — use /skills/code-review instead. -->
