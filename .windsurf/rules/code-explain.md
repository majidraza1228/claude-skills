<!-- Apply when: Use this skill when the user wants to understand code they didn't write or can't follow. Triggers on 'explain this code', 'what does this do', 'walk me through this', 'I don't understand this function', 'what is this regex', 'how does this algorithm work', 'explain this line by line', or 'what is this pattern called'. Also triggers on 'why is this written this way', 'what does this return', or 'summarize this file'. Do NOT use for reviewing code quality — use /skills/code-review instead. Do NOT use for fixing bugs — use /skills/debugging instead. -->
