<!-- Apply when: Use this skill when the user wants to add, improve, or review logging in their code. Triggers on 'add logging', 'how should I log this', 'structured logging', 'what should I log', 'logging best practices', 'observability', 'this is hard to debug in production', 'add tracing', 'log levels', or 'why can't I see what's happening'. Also triggers on 'correlation ID', 'request ID', 'log format', 'centralized logging', or 'when should I use error vs warn'. Do NOT use for fixing bugs found via logs — use /skills/debugging instead. -->
