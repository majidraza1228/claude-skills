<!-- Apply when: Use this skill when the user wants to write tests, practice test-driven development, asks 'write tests for this', 'how do I test this', 'TDD this feature', 'what should I test', 'test coverage', 'unit test', 'integration test', or 'mock this dependency'. Also triggers on 'red-green-refactor', 'test first', 'test pyramid', or 'write failing tests before code'. Do NOT use for reviewing existing tests — use /skills/code-review instead. Do NOT use for debugging failing tests — diagnose the root cause first. -->
