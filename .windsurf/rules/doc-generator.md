<!-- Apply when: Use this skill when the user wants to generate documentation from code, create API docs, write README files, produce function/class reference docs, or generate JSDoc/docstring/type documentation. Triggers on 'document this code', 'write docs for', 'generate API reference', 'add docstrings', 'create a README', or 'explain this module'. Covers Python, JavaScript, TypeScript, Go, Rust, and Java. Do NOT use for code review or finding bugs — use /skills/code-review instead. Do NOT use for writing tutorials or guides — use /skills/tutorial-writer instead. -->
