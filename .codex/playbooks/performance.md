<!-- Use when: Use this skill when the user wants to optimize speed, reduce memory usage, or fix slow code. Triggers on 'this is too slow', 'optimize this', 'reduce latency', 'high memory usage', 'performance review', 'profile this', 'N+1 query', 'this times out', 'slow API response', 'CPU spike', or 'how do I make this faster'. Also triggers on 'cache this', 'add an index', 'lazy load', or 'reduce bundle size'. Do NOT optimize without measuring first — this skill enforces measure-first. Do NOT use for correctness bugs — use /skills/debugging instead. -->
